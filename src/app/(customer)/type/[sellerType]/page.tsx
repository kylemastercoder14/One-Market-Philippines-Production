...
const SellerType = async (props: {
  params: Promise<{
    sellerType: string;
  }>;
}) => {
  const params = await props.params;
  const decodedSlug = decodeURIComponent(params.sellerType);
        ...
        <BreadcrumbList>
          ...
          <BreadcrumbItem>
            <BreadcrumbPage className="capitalize">
              {decodedSlug?.replace(/-/g, " ") || "Unknown Category"}
            </BreadcrumbPage>
          </BreadcrumbItem>
        </BreadcrumbList>
      </Breadcrumb>
          ...
          {products.length > 0 ? (
            ...
            <div className="flex flex-col items-center justify-center h-full">
              ...
              <p className="font-semibold mb-1">
                No products found in this type.
              </p>
