    ...
    <>
      <div className="flex items-center py-2 justify-between">
        <div className="flex items-center gap-3">
          ...
          />
          <div>
            <h1 className="font-semibold text-lg flex items-center gap-3">{seller?.name} <Badge className="bg-black hover:bg-black/90">Pro Account</Badge></h1>
        ...
        <Tabs defaultValue="info">
          ...
          <TabsContent value="info">
            <div className="flex w-full mt-3 flex-col">
              ...
              <div className="flex min-w-[450px] items-center justify-between rounded-md mt-3 py-2 px-3 bg-zinc-200">
