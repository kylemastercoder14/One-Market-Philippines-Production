    ...
    <div>
      ...
      <div className="grid md:grid-cols-2 grid-cols-1 gap-10 mt-5">
        ...
        <div className="bg-white border shadow-md p-5">
          ...
          <p className="text-sm text-gray-500 mt-2">
            Flash deal products that meet 1 Market Philippine&apos;s criteria
            are highlighted with a special tag. The cost of the flash deal is
            covered by the seller.
          </p>
          <div className="flex items-center gap-5 mt-5">
            <Link
        ...
        <div className="bg-white border shadow-md p-5">
          ...
          <p className="text-sm text-gray-500 mt-2">
            A shipping fee discount is a powerful tool to increase conversions.
            The cost of the shipping fee discount is covered by the seller.
          </p>
          <div className="flex items-center gap-5 mt-5">
            <Link
              className="text-orange-600 text-sm font-semibold hover:text-orange-600/80"
        ...
        <div className="bg-white border shadow-md p-5">
          ...
          <p className="text-sm text-gray-500 mt-2">
            Create coupon that customers can claim through product detail pages,
            search results, and the shopping cart. The cost of the coupon is
            covered by the seller.
          </p>
          <div className="flex items-center gap-5 mt-5">
            <Link
