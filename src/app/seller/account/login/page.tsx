          ...
          <div className="h-[500px] w-full col-span-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-1">
                ...
                <p className="font-bold text-black dark:text-white text-2xl">Seller Hub</p>
              </div>
            </div>
            <h2 className="bg-clip-text text-transparent bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-2xl md:text-4xl lg:text-7xl font-sans py-2 md:py-10 relative z-20 font-bold tracking-tight">
              ...
              <span className="dark:text-[#ff3661] text-[#8D021F]">1 Market Philippines</span>{" "}
              today!
            </h2>
            <p className="text-sm md:text-lg text-neutral-700 dark:text-neutral-400">
              ...
              you can sell on{" "}
              <span className="dark:text-[#ff3661] text-[#8D021F]">1 Market Philippines</span> no
              matter how many products you have. We can help accelerate your
              traffic.
            </p>
          </div>
          <div className="col-span-4">
            <div className="bg-white dark:bg-zinc-900 shadow-lg border px-6 py-6 rounded-md">
              <h3 className="font-helveticaBold text-2xl text-black dark:text-white">Login</h3>
              <div className="flex items-center gap-2">
                <p className="text-sm text-black dark:text-white">Don&apos;t have an account yet? </p>
                <Link
                  href="/seller/account/register"
                  className="dark:text-[#ff3661] text-[#8D021F] hover:underline text-sm"
                >
                  Sign Up
                </Link>
              </div>
